...
export default function HomePage() {
  return (
    <main className="min-h-screen relative overflow-x-hidden bg-background selection:bg-pink-500/20 selection:text-pink-600">
      {/* Background ambient lighting accents (GPU layer cached to eliminate scroll repaints) */}
      <div className="pointer-events-none fixed -top-40 -left-40 w-120 h-120 bg-pink-500/10 rounded-full blur-3xl -z-10 transform-gpu will-change-transform contain-paint" />
      <div className="pointer-events-none fixed top-1/3 -right-40 w-125 h-125 bg-blue-500/10 rounded-full blur-3xl -z-10 transform-gpu will-change-transform contain-paint" />
      <div className="pointer-events-none fixed -bottom-40 left-1/3 w-137.5 h-137.5 bg-purple-500/10 rounded-full blur-3xl -z-10 transform-gpu will-change-transform contain-paint" />
