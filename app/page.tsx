...
export default function HomePage() {
  return (
    <main className="min-h-screen relative overflow-x-hidden bg-background selection:bg-pink-500/20 selection:text-pink-600">
      ...
      <div className="pointer-events-none fixed -top-40 -left-40 w-[480px] h-[480px] bg-pink-500/10 rounded-full blur-3xl -z-10" />
      <div className="pointer-events-none fixed top-1/3 -right-40 w-[500px] h-[500px] bg-blue-500/10 rounded-full blur-3xl -z-10" />
      <div className="pointer-events-none fixed -bottom-40 left-1/3 w-[550px] h-[550px] bg-purple-500/10 rounded-full blur-3xl -z-10" />
