export function CreateBackground() {
  return (
    <div className="pointer-events-none fixed inset-0 overflow-hidden select-none -z-10">
      ...
      <div className="absolute top-1/3 -right-40 h-[480px] w-[480px] rounded-full bg-blue-500/15 blur-3xl" />

      {/* Bottom soft purple glow */}
      <div className="absolute -bottom-40 left-1/3 h-[480px] w-[480px] rounded-full bg-purple-500/15 blur-3xl" />
    </div>
  )
}
